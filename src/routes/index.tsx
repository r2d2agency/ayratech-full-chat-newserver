    ...
    <div className="p-8 space-y-4">
      ...
      <div className="bg-slate-950 p-6 rounded-xl font-mono text-sm text-slate-300 border border-slate-800 shadow-2xl">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-yellow-400 font-bold">[DICA] O arquivo de correção está em backend/src/fix_timezone_punches.js no código fonte. No Easypanel, tente rodar: `node src/fix_timezone_punches.js` ou `node fix_timezone_punches.js` dentro da pasta /app.</p>
        </div>
      </div>
    </div>
  );
